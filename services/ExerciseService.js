...
export const getMangaData = async (mangaId) => {
    console.log('Fetching exercise data for exercise:', mangaId); // Логування початку запиту
    try {
        const response = await fetch(`${API_CONFIG.BASE_URL}/exercise/get/manga/${mangaId}`, {
            headers: {
                'Accept': 'application/json'
            }
        });
